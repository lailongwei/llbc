 ...
 * @brief
 */
#ifndef __PYLLBC_COM_PACK_LEMMA_CLASS_H__
#define __PYLLBC_COM_PACK_LEMMA_CLASS_H__

#include "pyllbc/common/LibHeader.h"
#include "pyllbc/common/PackLemma.h"

/**
 * \brief The class type pack-lemma class encapsulation.
 */
class LLBC_HIDDEN pyllbc_PackLemma_Class : public pyllbc_PackLemma
{
...
public:
     ...
     */
    pyllbc_PackLemma_Class(PyObject *compileEnv = NULL);
    virtual ~pyllbc_PackLemma_Class();
...
private:
    /**
     * Get class from compile environment and class name.
     * @return PyObject * - the class object(new reference).
     */
    PyObject *GetClassFromEnvAndName();

private:
    bool _gotLeftAngle;

    LLBC_String _clsName;
    PyObject *_class;

    static std::map<LLBC_String, PyObject *> _rawClasses;
};

#endif // !__PYLLBC_COM_PACK_LEMMA_CLASS_H__
