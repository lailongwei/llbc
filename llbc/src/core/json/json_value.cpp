...
#include "llbc/core/json/value.h"
#include "llbc/core/json/writer.h"
...
#ifndef JSON_ASSERT_UNREACHABLE
...
Value::asInt() const
{
   ...
   case uintValue:
      ...
      return value_.uint_;
   case longValue:
       JSON_ASSERT_MESSAGE( value_.long_  >= minInt && value_.long_ <= maxInt, "Long out of signed integer range" );
       return Int( value_.long_ );
   case ulongValue:
       JSON_ASSERT_MESSAGE( value_.ulong_ <= (unsigned)maxInt, "ULong out of signed integer range" );
...
Value::asUInt() const
{
   ...
   case ulongValue:
       JSON_ASSERT_MESSAGE( value_.ulong_ <= maxUInt, "ulong out of unsigned integer range" );
...
Value::asDouble() const
{
   ...
   case uintValue:
      return value_.uint_;
   case longValue:
      return double(value_.long_);
   case ulongValue:
      return double(value_.ulong_);
   case realValue:
      return value_.real_;
   case booleanValue:
