 ...
 * @version 1.0
 *
 * @brief   llbc library bundle class encapsulation, Just use in IOS platform.
 */
#ifndef __LLBC_CORE_OS_OS_BUNDLE_H__
#define __LLBC_CORE_OS_OS_BUNDLE_H__
...
#endif // !__LLBC_CORE_OS_OS_BUNDLE_H__
