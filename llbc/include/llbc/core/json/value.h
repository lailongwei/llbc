...
/**
 * JsonValue data type typedef.
 */
typedef Json::Value LLBC_JsonValue;
typedef Json::Value::iterator LLBC_JsonValueIter;
typedef Json::Value::const_iterator LLBC_JsonValueCIter;
