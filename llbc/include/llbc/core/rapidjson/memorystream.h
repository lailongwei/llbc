...
#ifndef LLBC_RAPIDJSON_MEMORYSTREAM_H_
#define LLBC_RAPIDJSON_MEMORYSTREAM_H_
...
struct MemoryStream {
    ...
    Ch Peek() const { return LLBC_RAPIDJSON_UNLIKELY(src_ == end_) ? '\0' : *src_; }
    Ch Take() { return LLBC_RAPIDJSON_UNLIKELY(src_ == end_) ? '\0' : *src_++; }
...
#endif // LLBC_RAPIDJSON_MEMORYBUFFER_H_
