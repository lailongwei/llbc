...
#ifndef LLBC_RAPIDJSON_INTERNAL_SWAP_H_
#define LLBC_RAPIDJSON_INTERNAL_SWAP_H_
...
*/
template <typename T>
inline void Swap(T& a, T& b) LLBC_RAPIDJSON_NOEXCEPT {
    T tmp = a;
        a = b;
        b = tmp;
}
...
#endif // LLBC_RAPIDJSON_INTERNAL_SWAP_H_
