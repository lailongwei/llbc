...
#define LLBC_TINYXML2_LIB LLBC_EXPORT
...
/*
    ...
    Isn't clear why LLBC_TINYXML2_LIB is needed; but seems to fix #719
*/
class LLBC_TINYXML2_LIB StrPair
{
public:
    enum Mode {
...
/**
	...
	@sa XMLNode::Accept()
*/
class LLBC_TINYXML2_LIB XMLVisitor
{
public:
    virtual ~XMLVisitor() {}
...
/** XMLNode is a base class for every object that is in the
	...
	@endverbatim
*/
class LLBC_TINYXML2_LIB XMLNode
{
...
*/
class LLBC_TINYXML2_LIB XMLText : public XMLNode
{
    friend class XMLDocument;
public:
...
/** An XML Comment. */
class LLBC_TINYXML2_LIB XMLComment : public XMLNode
{
    friend class XMLDocument;
public:
    virtual XMLComment*	ToComment()					{
...
*/
class LLBC_TINYXML2_LIB XMLDeclaration : public XMLNode
{
    friend class XMLDocument;
public:
    virtual XMLDeclaration*	ToDeclaration()					{
...
*/
class LLBC_TINYXML2_LIB XMLUnknown : public XMLNode
{
    friend class XMLDocument;
public:
    virtual XMLUnknown*	ToUnknown()					{
...
*/
class LLBC_TINYXML2_LIB XMLAttribute
{
    friend class XMLElement;
public:
...
*/
class LLBC_TINYXML2_LIB XMLElement : public XMLNode
{
    friend class XMLDocument;
public:
...
*/
class LLBC_TINYXML2_LIB XMLDocument : public XMLNode
{
    friend class XMLElement;
...
*/
class LLBC_TINYXML2_LIB XMLHandle
{
public:
...
*/
class LLBC_TINYXML2_LIB XMLConstHandle
{
public:
...
/**
	...
	@endverbatim
*/
class LLBC_TINYXML2_LIB XMLPrinter : public XMLVisitor
{
public:
