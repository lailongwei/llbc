 ...
 * @brief
 */
#ifndef __LLBC_CORE_LOG_LOG_NEW_LINE_TOKEN_H__
#define __LLBC_CORE_LOG_LOG_NEW_LINE_TOKEN_H__
 ...
 */
class LLBC_LogNewLineToken : public LLBC_BaseLogToken
{
public:
    LLBC_LogNewLineToken();
    virtual ~LLBC_LogNewLineToken();
...
#endif // !__LLBC_CORE_LOG_LOG_NEW_LINE_TOKEN_H__
