 ...
 * @brief
 */
#ifndef __LLBC_CORE_LOG_LOG_ESCAPE_TOKEN_H__
#define __LLBC_CORE_LOG_LOG_ESCAPE_TOKEN_H__
...
/**
 * \brief The escape log token class encapsulation.
 */
class LLBC_HIDDEN LLBC_LogEscapeToken : public LLBC_BaseLogToken
{
public:
    LLBC_LogEscapeToken();
    virtual ~LLBC_LogEscapeToken();
...
#endif // !__LLBC_CORE_LOG_LOG_ESCAPE_TOKEN_H__
