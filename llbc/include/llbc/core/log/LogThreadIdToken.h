 ...
 * @brief
 */
#ifndef __LLBC_CORE_LOG_LOG_THREAD_ID_TOKEN_H__
#define __LLBC_CORE_LOG_LOG_THREAD_ID_TOKEN_H__
...
#endif // !__LLBC_CORE_LOG_LOG_THREAD_ID_TOKEN_H__
