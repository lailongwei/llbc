 ...
 * @brief
 */
#ifndef __LLBC_CORE_LOG_LOG_LINE_TOKEN_H__
#define __LLBC_CORE_LOG_LOG_LINE_TOKEN_H__
...
/**
 * \brief The line log token class encapsulation.
 */
class LLBC_HIDDEN LLBC_LogLineToken : public LLBC_BaseLogToken
{
public:
    LLBC_LogLineToken();
    virtual ~LLBC_LogLineToken();
...
#endif // !__LLBC_CORE_LOG_LOG_LINE_TOKEN_H__
