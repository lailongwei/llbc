...
int TestCase_Core_Utils_Network::Run(int argc, char *argv[])
{
    ...
    this->VerifyIPv4Addr("www.baidu.com");
    this->VerifyIPv4Addr("127.0.0.1");
    this->VerifyIPv4Addr("0.0.0.0");
    this->VerifyIPv4Addr("255.255..");
    this->VerifyIPv4Addr("10.1.1.1.222");
    this->VerifyIPv4Addr("a.b.1.3");
