...
__DEFINE_TEST_CASE(TestCase_Core_OS_Signal)
__DEFINE_TEST_CASE(TestCase_Core_Algo_Hash)
...
__DEFINE_TEST_CASE(TestCase_Core_Config_Properties)
...
__DEFINE_TEST_CASE(TestCase_Comm_RecentLoadInfo)
